...
const mapCurrentEvents = () => {
  // Solution code here...
  let resultMap=currentEvents.news.map(ele=>{
      let creatEvent=new Event(ele);
      return creatEvent;
  });
  return resultMap;
}
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let countArr=arr.reduce((accumulator,value,i)=>{
    accumulator+=1;
    return accumulator;
  },0);
  return countArr;
...
const returnNames = (arr) => {
  // Solution code here...
  let namesArr=arr.reduce((accumulator,obj,i)=>{
    accumulator.push(obj.name);
    return accumulator;
  },[]);
  return namesArr;
};
...
const reversedString = (str) => {
  // Solution code here...
  return str.split("").reduce((rev,ele)=>ele+rev,'');
};
